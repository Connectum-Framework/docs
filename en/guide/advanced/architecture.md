...
Connectum is a modular gRPC/ConnectRPC framework for Node.js 25.2.0+. It is organized as 6 packages in 3 dependency layers.
...
|----------|---------|-----|
| Native TypeScript | Node.js 25.2.0+ type stripping, no build step | [ADR-001](/en/contributing/adr/001-native-typescript-migration) |
