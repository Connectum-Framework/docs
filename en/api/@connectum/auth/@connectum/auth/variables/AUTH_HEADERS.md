[Connectum API Reference](../../../../../index.md) / [@connectum/auth](../../../index.md) / [@connectum/auth](../index.md) / AUTH\_HEADERS

# Variable: AUTH\_HEADERS

> `const` **AUTH\_HEADERS**: `object`

Defined in: [packages/auth/src/types.ts:49](https://github.com/Connectum-Framework/connectum/blob/96762e118a8bb27fc102c6480cb8fed0afa3ac8a/packages/auth/src/types.ts#L49)
