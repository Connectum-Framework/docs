...
Defined in: [packages/auth/src/testing/with-context.ts:31](https://github.com/Connectum-Framework/connectum/blob/main/packages/auth/src/testing/with-context.ts#L31)
