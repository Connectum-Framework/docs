[Connectum API Reference](../../../../index.md) / [@connectum/test-fixtures](../../index.md) / [index](../index.md) / createMockStream

# Function: createMockStream()

> **createMockStream**\<`T`\>(`items`, `options?`): `AsyncIterable`\<`T`\>

Defined in: [mock-stream.ts:35](https://github.com/Connectum-Framework/connectum/blob/19a3629e21bbbb6bb1914ecc539b8c29d9ab24c5/packages/test-fixtures/src/mock-stream.ts#L35)
