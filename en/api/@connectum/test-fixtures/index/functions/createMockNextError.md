[Connectum API Reference](../../../../index.md) / [@connectum/test-fixtures](../../index.md) / [index](../index.md) / createMockNextError

# Function: createMockNextError()

> **createMockNextError**(`code`, `message?`): `any`

Defined in: [mock-next.ts:68](https://github.com/Connectum-Framework/connectum/blob/caf5b110b00f27241af3e0656091ebf408eea7a0/packages/test-fixtures/src/mock-next.ts#L68)
