[Connectum API Reference](../../../../index.md) / [@connectum/test-fixtures](../../index.md) / [index](../index.md) / createFakeService

# Function: createFakeService()

> **createFakeService**(`options?`): `DescService`

Defined in: [fake-service.ts:34](https://github.com/Connectum-Framework/connectum/blob/19a3629e21bbbb6bb1914ecc539b8c29d9ab24c5/packages/test-fixtures/src/fake-service.ts#L34)
